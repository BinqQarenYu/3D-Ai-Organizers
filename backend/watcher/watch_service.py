...
from backend.indexer.asset_record import load_asset_metadata, save_asset_metadata, create_initial_record

logger = logging.getLogger(__name__)

SUPPORTED_EXTENSIONS = {".fbx", ".obj", ".blend", ".gltf", ".glb", ".png", ".jpg", ".jpeg"}
